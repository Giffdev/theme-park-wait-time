...
// NOTE: Oceans of Fun (b5a89552-3381-47ad-88cc-ab0087019c8b) used to require a
// virtual-split fabrication here because ThemeParks Wiki previously exposed
// only a single combined Worlds of Fun entity. It now reports Oceans of Fun as
// its own distinct destination park (with its own real attractions/schedule),
// so this script's normal per-park loop already seeds it correctly under its
// real id — no special-casing needed.

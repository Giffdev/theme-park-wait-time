...
const parks = [
  { id: 'universal-orlando', name: 'Universal Studios', location: 'Orlando' },
  { id: 'islands-of-adventure', name: 'Islands of Adventure', location: 'Orlando' },
  { id: 'epic-universe', name: 'Epic Universe', location: 'Orlando' },
  { id: 'hollywood-studios', name: 'Hollywood Studios', location: 'Orlando' },
  { id: 'animal-kingdom', name: 'Animal Kingdom', location: 'Orlando' },
  { id: 'magic-kingdom', name: 'Magic Kingdom', location: 'Orlando' }
]

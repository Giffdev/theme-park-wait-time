  ...
  if (!user) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-4 text-center">
        ...
        <h2 className="text-xl font-semibold text-primary-800">Sign in to view your dashboard</h2>
        <p className="text-primary-500 max-w-sm">
          Create an account or sign in to see your park stats and manage your account.
        </p>
        <Link
          href="/auth/signin"

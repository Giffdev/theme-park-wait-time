...
> theme-park-wait-times — Theme park visit tracker with real-time wait times, crowd calendars, ride logging, and visit planning.
...
- **Competitors:** thrill-data.com (useful data, poor UI design)

...
| --- | --- | --- | --- |
| Lead | Lead / Architect | review | Application mapping, architecture boundaries, recovery planning, evidence-based review |
| Frontend | Frontend Dev | advisory | React/Next.js interactions, client state, accessible responsive UI |
| Scheduler | React Timing Specialist | advisory | React hooks, timers, async scheduling, visibility/connectivity events, Strict Mode, deterministic f… |
| Backend | Backend Dev | edit | Firestore modeling, read/write contracts, query design, migration safety |
| Tester | Tester / QA | review, edit | Failure reproduction, integration testing, end-to-end testing, regression design |
| Reliability | Reliability Engineer | edit | Persistence protocols, concurrency control, offline recovery, reload durability |
| Rai | RAI Reviewer | review | RAI review, content safety, bias detection, credential scanning, ethical pattern review. |
| Fact Checker | Devil's Advocate & Verification Agent | review | Verification, fact-checking, counter-hypotheses, hallucination detection. |

### Supported task types

Lead / Architect, Frontend Dev, React Timing Specialist, Backend Dev, Tester / QA, Reliability Engineer, RAI Reviewer, Devil's Advocate & Verification Agent
...
- **Can:** review code and pull requests; write and modify code; write and run tests; security and secrets review; responsible-AI and content-safety review
- **Cannot (no agent claims this):** write and maintain documentation; cut releases and publish packages; author and maintain CI/CD workflows; UX and visual design; deploy to live environments
